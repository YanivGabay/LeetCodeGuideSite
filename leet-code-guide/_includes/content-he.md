...
1. **[למה LeetCode?](#-למה-אנחנו-פותרים-ולמה-זה-חשוב)**
2. **[חיבור וניווט ראשוני](#-חיבורהרשמה-וניווט-ראשוני)**
3. **[כיצד לבחור שאלה](#-כיצד-לבחור-שאלה)**
4. **[איך לפתור שאלה](#-איך-לפתור-שאלה)**
5. **[כיצד להתפעל עם הפלטפורמה - הערות על אזור הקוד](#-כיצד-להתפעל-עם-הפלטפורמה---הערות-על-אזור-הקוד)**
6. **דוגמאות קוד**
    1. **[C++](#-c)**
    2. **[Python](#-python)**
